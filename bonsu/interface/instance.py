	...
	if subpanelname in subpanel_items:
		...
		if subpanelname == 'View Object':
			...
			try:
				...
				pass
			try:
				panelphase.pipelineitems[idx].ntheta.value.SetValue(object[17])
				panelphase.pipelineitems[idx].npsi.value.SetValue(object[18])
			except:
				pass
			panelphase.pipelineitems[idx].OnRadioSelect(None)
			DoListCheck(panelphase, object, idx)
		if subpanelname == 'View Chopped':
			...
			panelphase.pipelineitems[idx].coords_filename.objectpath.SetValue(object[1])
			panelphase.pipelineitems[idx].contour.value.SetValue(object[2])
			panelphase.pipelineitems[idx].phasemax.value.SetValue(object[3])
			panelphase.pipelineitems[idx].phasemin.value.SetValue(object[4])
			panelphase.pipelineitems[idx].theta.value.SetValue(object[5])
			panelphase.pipelineitems[idx].psi.value.SetValue(object[6])
			panelphase.pipelineitems[idx].separation.value.SetValue(object[7])
			panelphase.pipelineitems[idx].thickness.value.SetValue(object[8])
			panelphase.pipelineitems[idx].chkbox_axes.SetValue(object[9])
			try:
				panelphase.pipelineitems[idx].feature_angle.value.SetValue(object[10])
				panelphase.pipelineitems[idx].axes_fontfactor.value.SetValue(object[11])
			except Exception as e:
				print(f'While loading View Chopped, particularly FA and axes FF, {type(e)} - {e}')
			try:
				panelphase.pipelineitems[idx].meshsubiter.value.SetValue(object[12])
			except Exception as e:
